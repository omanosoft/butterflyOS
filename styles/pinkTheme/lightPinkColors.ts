const colors = {
  background: "rgba(255, 215, 240, 1)",
  fileEntry: {
    background: "rgba(255, 230, 235, 1)",
    backgroundFocused: "rgba(255, 182, 193, 1)",
    backgroundFocusedHover: "rgba(255, 182, 163, 1)",
    border: "hsla(330, 70%, 75%, 0.5)",
    borderFocused: "hsla(330, 80%, 75%, 0.7)",
    borderFocusedHover: "hsla(330, 90%, 75%, 0.8)",
    text: "#FF80C0",
    textShadow: `
  ...
  progressBackground: "rgba(255, 215, 240, 1)",
  ...
  titleBar: {
    ...
    buttonInactive: "rgba(255, 230, 235, 1)",
    closeHover: "rgba(255, 140, 255, 1)",
    text: "rgb(255, 255, 255)",
    textInactive: "rgba(255, 230, 235, 1)",
  },
  fileExplorer: {
    background: "rgba(255, 140, 255, 1)",
    navigationBackground: "rgba(255, 160, 190, 1)",
    navigationIcons: "rgba(255, 230, 235, 1)",
    inputFieldsBackground: "rgba(255, 230, 235, 1)",
